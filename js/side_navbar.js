...
$(document).ready(function () {
    $(document.body).append(`
        <aside class="position-fixed top-0 bottom-0 d-flex z-${location.pathname.endsWith('/') || location.pathname.endsWith('index.html') ? 2 : 3}">
            <div id="side-navbar"
            ...
            <div class="d-flex flex-column justify-content-between align-items-center h-100 bg-white px-2 py-4">
                <img src="${location.pathname.endsWith('/') || location.pathname.endsWith('index.html') ? '' : '.'}./logo.png" alt="yummy logo" />
